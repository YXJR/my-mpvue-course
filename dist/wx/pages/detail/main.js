...
exports.default = {
  ...
  components: { Star: _Star2.default },
  ...
  methods: {
    collect: function collect(id) {
      ...
      var idMessage = wx.getStorageSync("idMessage");
      var openid = JSON.parse(idMessage).openid;
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": 'cloud://xiaopower20190321-srswa.7869-xiaopower20190321-srswa-1303938263/' + _vm.detailData.image_path
    }
  ...
  }, [_vm._v("口味：7.8 环境：" + _vm._s(_vm.detailData.environment) + "服务：" + _vm._s(_vm.detailData.service))]), _vm._v(" "), _c('li', {
    staticClass: "store_type"
  }, [_vm._v("上地 快餐简餐")])], 1)], 1), _vm._v(" "), _c('div', {
    staticClass: "local"
  }, [_c('div', {
  ...
  }, [_c('span', [_vm._v(_vm._s(_vm.detailData.place))]), _vm._v(" "), _c('p', [_vm._v("距离步行60m，需要1分钟")])], 1), _vm._v(" "), _vm._m(0)])]), _vm._v(" "), _c('div', {
    staticClass: "rule"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2d6938ad", esExports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-2d6938ad"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2d6938ad_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d6938ad", Component.options)
  } else {
    hotAPI.reload("data-v-2d6938ad", Component.options)
  }
