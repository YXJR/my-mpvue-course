      ...
      <div class="detail_content">
        <div class="imgContainer">
          <img
            ...
            :src="'cloud://xiaopower20190321-srswa.7869-xiaopower20190321-srswa-1303938263/'+detailData.image_path"
          />
        </div>
        <ul>
          ...
          <li class="store_taste">口味：7.8 环境：{{detailData.environment}}服务：{{detailData.service}}</li>
          <li class="store_type">上地 快餐简餐</li>
        </ul>
      </div>
      <div class="local">
        <div class="content-show">
          <img src="/static/images/clock.png" /> {{detailData.shopHours || ''}}
